...
//  *case.1 선언
var userName; //? name이라는 변수가 선언됨(초기화 안됨 == 정의되지 않음(미정의))

// *case.2 선언 및 초기화
var userName = "Mark";
// ! 개발 언어는 <자료형을 근거로 둔 순환> 을 하기 때문에 대상이 명확하게 명시되어야 함

//  *case.3 위 예제의 문제점
//  ! 변수는 위 <언급한 바 대로 순환> 할 수 있는 도구여야 함
var cup; //? 컵을 만들었다
cup = 'greenTea'; //? 컵에 녹차를 담았다
/* = 는 같다(==) 가 아니라 <좌변에 우변을 대입하라> 임 */
...
// todo. 자신의 나이를 cliAge라는 변수에 담고 20년 뒤 나이를 console에 출력해보자
var cliAge = 24;
